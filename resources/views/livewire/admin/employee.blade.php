                                ...
                                <div class="toggle-expand-content" data-content="more-options">
                                    <ul class="nk-block-tools g-3">
                                        ...
                                        <li class="nk-block-tools-opt"><a href="#"
                                                ...
                                                class="btn btn-primary d-none d-md-inline-flex" data-toggle="modal" data-target="#addModal"><em
                        ...
                        <div class="nk-tb-item">
                            ...
                            <div class="nk-tb-col"><a href="/demo2/ecommerce/customer-details.html">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info"><span class="tb-lead">{{$employee->gender}} <span
                                                    class="dot dot-success d-md-none ms-1"></span></span><span>info@softnio.com</span>
                                        </div>
                                    </div>
                                </a></div>
                            <div class="nk-tb-col tb-col-mb"><span class="tb-amount">35,040.34 <span
                            ...
                            <div class="nk-tb-col tb-col-md"><span class="tb-status text-warning">Active</span></div>
