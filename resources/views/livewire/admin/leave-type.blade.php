                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Leave Types</h3>
                                ...
                                <div class="nk-block">
                                    <div class="nk-tb-list is-separate is-medium mb-3">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col tb-col-md"><span>Duration</span></div>
                                            ...
                                            <div class="nk-tb-col nk-tb-col-tools">
                                                <ul class="nk-tb-actions gx-1">
                                                    <div class="drodown mr-n1">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="#deleteLeaveType"
                                                                        wire:click.prevent="deleteLeaveType({{ $leavetype->id }})">Delete</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-top" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    ...
                    <form wire:submit.prevent="addLeaveType" class="mt-2">
                        <div class="row g-gs">

                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label" for="oder-id">Leave Name</label>
                                    <div class="form-control-wrap">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="order-id">Duration</label>
                                    <div class="form-control-wrap">
                                        <input wire:model="duration" type="number" class="form-control" id="order-id"
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-secondary">
                                    <div wire:loading wire:target='addLeaveType'>
                                    </div>Add
                                </button>
