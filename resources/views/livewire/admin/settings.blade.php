                        ...
                        <div class="tab-content">
                                    ...
                                    <form action="#" class="gy-3 form-settings">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="form-group">
                                                    <div class="form-control-wrap"><input type="text"
                                                            class="form-control" id="comp-name" value="Company Name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row g-3 align-center">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="form-group">
                                                    <div class="form-control-wrap"><input type="text"
                                                            class="form-control" id="comp-email"
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt"><a data-bs-toggle="modal"
                                                                href="#addAdmin" class="btn text-white bg-primary"><em
                                                    ...
                                                    <div class="card-tools">
                                                        <div class="form-inline flex-nowrap gx-3">
                                                            <div class="form-wrap w-150px"><select
                                                                    ...
                                                                    aria-hidden="true">
                                                                    <option value="" data-select2-id="3">Bulk
                                                                        Action</option>
                                                                    <option value="email">Send Email
                                                                    </option>
                                                                    <option value="group">Change Group
                                                                    </option>
                                                                    ...
                                                                    style="width: auto;"><span class="selection"><span
                                                                            ...
                                                                            aria-disabled="false"
                                                                            aria-labelledby="select2-08it-container"><span
                                                                                class="select2-selection__rendered"
                                                                                id="select2-08it-container"
                                                                                role="textbox"
                                                                                aria-readonly="true"><span
                                                                                    class="select2-selection__placeholder">Bulk
                                                                                                        ...
                                                                                                        <label
                                                                                                            ...
                                                                                                            style="width: auto;"><span
                                                                                                                class="selection"><span
                                                                                                                    ...
                                                                                                                    tabindex="0"
                                                                                                                    aria-disabled="false"
                                                                                                                    aria-labelledby="select2-g1oa-container"><span
                                                                                                                        class="select2-selection__rendered"
                                                                                                                        id="select2-g1oa-container"
                                                                                                                        role="textbox"
                                                                                                                        aria-readonly="true"
                                                                                                                        title="Any Role">Any
                                                                                                                        Role</span><span
                                                                                                        ...
                                                                                                        <label
                                                                                                            ...
                                                                                                            style="width: auto;"><span
                                                                                                                class="selection"><span
                                                                                                                    ...
                                                                                                                    tabindex="0"
                                                                                                                    aria-disabled="false"
                                                                                                                    aria-labelledby="select2-59fg-container"><span
                                                                                                                        class="select2-selection__rendered"
                                                                                                                        id="select2-59fg-container"
                                                                                                                        role="textbox"
                                                                                                                        aria-readonly="true"
                                                ...
                                                <div class="nk-tb-list nk-tb-ulist">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><span
                                                                class="sub-text">ID</span></div>
                                                        <div class="nk-tb-col"><span class="sub-text">Name</span>
                                                        </div>
                                                        <div class="nk-tb-col"><span class="sub-text">Role</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><a href="#">#456</a>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                        ...
                                                        <div class="nk-tb-col"><span
                                                                class="badge text-medium text-success">Admin</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-sm"><span
                                                                class="tb-status bg-success badge badge-dot">Active</span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-2">
                                                                <li class="nk-tb-action-hidden"><a href="#"
                                                                        ...
                                                                        data-bs-original-title="Send Email"><em
                                                                ...
                                                                <li class="nk-tb-action-hidden"><a href="#"
                                                                        ...
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        aria-label="Delete"
                                                                        data-bs-original-title="Delete"><em
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><a href="#">#457</a>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name"><span class="tb-lead">Bruce
                                                                        Wayne</span></div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col"><span
                                                                class="badge text-medium text-primary">Co-Admin</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-sm"><span
                                                                class="tb-status bg-success badge badge-dot">Active</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><a href="#">#496</a>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name"><span class="tb-lead">Iliash
                                                                        Hossain</span></div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col"><span
                                                                class="badge text-medium text-info">Co-admin</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-sm"><span
                                                                class="tb-status bg-warning badge badge-dot">Inactive</span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-2">
                                                                <li class="nk-tb-action-hidden"><a href="#"
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><a href="#">#458</a>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name"><span class="tb-lead">Jahangir
                                                                        Alom</span></div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col"><span
                                                                class="badge text-medium text-warning">Moderator</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-sm"><span
                                                                class="tb-status bg-success badge badge-dot">Active</span>
                                                        </div>
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><a href="#">#459</a>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <div class="user-card">
                                                                ...
                                                                <div class="user-name"><span class="tb-lead">Fuad
                                                                        Alom</span></div>
                                                            </div>
                                                        </div>
                                                        <div class="nk-tb-col"><span
                                                                class="badge text-medium text-primary">Moderator</span>
                                                        </div>
                                                        <div class="nk-tb-col tb-col-sm"><span
                                                                class="tb-status bg-danger badge badge-dot">Suspended</span>
                                                        </div>
                                                        <div class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-2">
                                                                <li class="nk-tb-action-hidden"><a href="#"
                                ...
                                <div class="card-inner pt-0">
                                    ...
                                    <div class="row g-gs">
                                        <div class="col-lg-4 col-xxl-3 col-sm-6">
                                            <div class="card shadow-none"><img src="/demo1/images/crm/theme/a.jpg"
                                                    class="border border-light rounded" alt="">
                                                <div class="card-inner pt-3 p-0">
                                                    <p class="card-text">Lorem ipsum dolor sit amet
                                                        consectetur,
                                                        adipisicing elit. Expedita, sapiente!</p><a href="#"
                                        ...
                                        <div class="col-lg-4 col-xxl-3 col-sm-6">
                                            <div class="card shadow-none"><img src="/demo1/images/crm/theme/b.jpg"
                                                    class="border border-light rounded" alt="">
                                                <div class="card-inner pt-3 p-0">
                                                    <p class="card-text">Lorem ipsum dolor sit amet
                                                        consectetur,
                                        ...
                                        <div class="col-lg-4 col-xxl-3 col-sm-6">
                                            <div class="card shadow-none"><img src="/demo1/images/crm/theme/c.jpg"
                                                    class="border border-light rounded" alt="">
                                                <div class="card-inner pt-3 p-0">
                                                    <p class="card-text">Lorem ipsum dolor sit amet
                                                        consectetur,
                            ...
                            <div class="tab-pane" id="email" role="tabpanel">
                                <div class="card-inner pt-0">
                                    ...
                                    <div class="row g-gs">
                                        <div class="col-md-12">
                                            <div class="form-group"><label class="form-label">E-mail to
                                                    Lead</label>
                                                <ul class="custom-control-group g-3 align-center">
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="lead-dis"><label class="custom-control-label"
                                                                for="lead-dis">About Discount</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="lead-pro"><label class="custom-control-label"
                                                                for="lead-pro">About Product</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="lead-det"><label class="custom-control-label"
                                                                for="lead-det">Product Details</label>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="form-label">E-mail to
                                                ...
                                                <ul class="custom-control-group g-3 align-center">
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="cus-dis"><label class="custom-control-label"
                                                                for="cus-dis">About Discount</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="cus-pro"><label class="custom-control-label"
                                                                for="cus-pro">About Product</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="cus-det"><label class="custom-control-label"
                                                                for="cus-det">Product Details</label>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="form-label">E-mail to
                                                ...
                                                <ul class="custom-control-group g-3 align-center">
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="emp-holiday"><label class="custom-control-label"
                                                                for="emp-holiday">Holiday</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="emp-policy"><label class="custom-control-label"
                                                                for="emp-policy">Updated Policy</label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="emp-salary"><label class="custom-control-label"
                                                                for="emp-salary">About Salary</label>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
